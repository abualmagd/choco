...
})({"lQlrh":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "d229a11c9d4141df";
"use strict";
...
},{}],"ihhsy":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _alpinejs = require("alpinejs");
var _alpinejsDefault = parcelHelpers.interopDefault(_alpinejs);
var _productGalleryStore = require("./stores/productGalleryStore");
var _productGalleryStoreDefault = parcelHelpers.interopDefault(_productGalleryStore);
var _cartStore = require("./stores/cartStore");
var _cartStoreDefault = parcelHelpers.interopDefault(_cartStore);
var _cartComponent = require("./components/cartComponent");
var _cartComponentDefault = parcelHelpers.interopDefault(_cartComponent);
var _favoriteComponent = require("./components/favoriteComponent");
var _favoriteComponentDefault = parcelHelpers.interopDefault(_favoriteComponent);
var _authModalComponent = require("./components/authModalComponent");
var _authModalComponentDefault = parcelHelpers.interopDefault(_authModalComponent);
var _accountComponent = require("./components/accountComponent");
var _accountComponentDefault = parcelHelpers.interopDefault(_accountComponent);
var _adressComponent = require("./components/adressComponent");
var _adressComponentDefault = parcelHelpers.interopDefault(_adressComponent);
var _itemComponent = require("./components/itemComponent");
...
},{}],"al2ys":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = {
    instance: null,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kZQ1H":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "logoutCurrentUser", ()=>logoutCurrentUser);
parcelHelpers.export(exports, "addNewAddress", ()=>addNewAddress);
...
const updateItemQuatity = async (id, quantity)=>{
...
const registerEmail = async (data)=>{
    try {
        ...
        if (!response.ok) {
            if (response.status === 401) throw new Error("user may be registered before");
...
parcelHelpers.defineInteropFlag(exports);
var _api = require("../utils/api");
exports.default = cartComponent = (productId)=>({
        count: 1,
        size: 8,
        color: "yellow",
        isLoading: false,
...
var _api = require("../utils/api");
var _services = require("../utils/services");
exports.default = favoriteComponent = (productId)=>({
        isLoading: false,
        isLiked: false,
        likedList: [],
        init () {
            ...
            if (!Array.isArray(this.likedList)) this.likedList = [];
...
},{"../utils/api":"f2P3u","../utils/services":"fXQWd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ats9P":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _api = require("../utils/api");
var _services = require("../utils/services");
exports.default = authModalComponent = ()=>({
        ...
        async LoginWithEmail () {
            ...
            try {
                await (0, _api.loginEmail)({
                    email: this.email,
                    password: this.password
                });
                this.promise = "done";
                (0, _services.notify)("logined seccussfully");
        ...
        async RegisterUser () {
            ...
            try {
                ...
                this.promise = "done";
                (0, _services.notify)("registerd seccussfully");
                this.$refs.dialog.close();
            } catch (error) {
                (0, _services.notify)(error, true);
                this.promise = "done";
...
},{"../utils/api":"f2P3u","../utils/services":"fXQWd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2gfxn":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _api = require("../utils/api");
var _services = require("../utils/services");
exports.default = accountComponent = (user)=>({
        user: user,
        editable: false,
        name: user?.name ?? "",
        ...
        async logUserOut () {
            try {
                ...
                (0, _services.notify)("logout successfully");
            } catch (error) {
                (0, _services.notify)(error);
            }
        },
        async updateMyUser () {
            try {
                this.isLoading = true, await (0, _api.updateUserData)({
                    name: this.name,
                    phone: this.userPhone
                }, user.id);
                (0, _services.notify)("updated well");
            } catch (error) {
                (0, _services.notify)(error, true);
                this.isLoading = false;
            } finally{
...
},{"../utils/api":"f2P3u","../utils/services":"fXQWd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hsTDP":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _api = require("../utils/api");
var _services = require("../utils/services");
exports.default = addressComponent = (address)=>({
        id: address?.id ?? null,
        ...
        async updateAddress () {
            if (this.id) {
                ...
                try {
                    ...
                    (0, _services.notify)("address updated");
                } catch (error) {
                    (0, _services.notify)(error, true);
                }
            } else {
                ...
                try {
                    ...
                    (0, _services.notify)("address created");
                } catch (error) {
                    (0, _services.notify)(error, true);
                }
            }
...
},{"../utils/api":"f2P3u","../utils/services":"fXQWd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lhy3p":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _api = require("../utils/api");
var _services = require("../utils/services");
exports.default = itemComponent = (item)=>({
        ...
        async icreamentQuantity () {
            ...
            try {
                await (0, _api.updateItemQuatity)(this.id, this.quantity);
                (0, _services.notify)("qauntity updated well");
        ...
        async decreamentQuantity () {
            if (this.quantity == 1) return null;
            else {
                this.quantity = this.quantity - 1;
                try {
                    await (0, _api.updateItemQuatity)(this.id, this.quantity);
        ...
        async removeItem () {
            try {
                await (0, _api.removeCartItem)(item.id);
                (0, _services.notify)("item deleted well ");
        ...
        computeTotal () {
            if (this.product !== null) return (this.quantity * this.product.price) ?? 0;
            else return (this.quantity * this.variant.price) ?? 0;
        }
    });

},{"../utils/api":"f2P3u","../utils/services":"fXQWd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lQlrh","ihhsy"], "ihhsy", "parcelRequire6986", {})
